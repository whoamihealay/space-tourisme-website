...
const Nav = () => {
  ...
  const activeStyles = "border-white mobile:border-l-4 tablet:border-b-4";
  ...
  useEffect(() => {
    switch (activeRouter.route) {
      case "/":
        setActiveHome(activeStyles);
        break;
      case "/destination":
        setActiveDest(activeStyles);
        break;
      case "/crew":
        setActiveCrew(activeStyles);
        break;
      case "/technologies":
        setActiveTech(activeStyles);
        break;
      default:
        break;
    }
  ...
  return <>
    ...
    >
      <ul className="mobile:my-32 mobile:mx-4 tablet:flex tablet:gap-12 desktop:gap-8 items-center">
        ...
        >
          <Link href="/destination" className="text-white flex gap-2">
        ...
        >
          <Link href="crew" className="text-white flex gap-2">
        ...
        >
          <Link href="/technologies" className="text-white flex gap-2">
